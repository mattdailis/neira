import{s as Nr,q as Rr,u as Ar,v as Dr,w as kr}from"../chunks/scheduler.Ce_0Mfso.js";import{S as Pr,i as xr,e as X,s as he,c as J,g as ns,a as ue,h as ss,f as L,b as G,q as Wt,d as $,k as Ut,p as Or,n as Mr}from"../chunks/index.BToHiQLN.js";import"../chunks/paths.Dzvo65EY.js";var is={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Th(n){ma(ia),pt(new je("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Ch(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),be(gs,ms,n),be(gs,ms,"esm2017")}ee.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ee.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Th();const Nh=!0,Rh=!1;async function Ah({params:n}){const t=ui({apiKey:"AIzaSyC4wR7v4I0iMKzy_h_BjQ-RGgJrJV7knsc",authDomain:"neira-f9621.firebaseapp.com",databaseURL:"https://neira-f9621.firebaseio.com",projectId:"neira-f9621",storageBucket:"neira-f9621.appspot.com",messagingSenderId:"107972862685",appId:"1:107972862685:web:58b89d4c93648c3bc63134"}),s=bh(t);console.log({db:s,ref:ht,set:Qs});async function i(l){await Qs(ht(s,"users/foo"),{username:"abc",email:l})}console.log({update:i});const r=ht(s,"races"),o=ht(s,"founders-day/2025"),a=await Promise.all([new Promise(l=>{const c=Xs(r,u=>{const h=u.val();c(),l({races:h})})}),new Promise(l=>{const c=Xs(o,u=>{const h=u.val();c();const d=[];for(const _ of h.head_to_head)if(_.results!==void 0)for(const p of _.results)_.class==="fours"&&_.gender==="girls"&&_.varsity_index==="1"&&d.push([p.school1,p.school2,p.margin,h.day,h.url]);l({foundersDay:d})})})]);return{races:a[0].races,foundersDay:a[1].foundersDay}}const Mh=Object.freeze(Object.defineProperty({__proto__:null,load:Ah,prerender:Nh,ssr:Rh},Symbol.toStringTag,{value:"Module"}));function Dh(n){let e,t="neira",s,i,r,o,a,l,c,u,h,d,_,p,E,A='<span class="w3-bar-item w3-right">neira</span>',K,H,Q;const Le=n[1].default,V=Rr(Le,n,n[0],null);return{c(){e=X("title"),e.textContent=t,s=he(),i=X("meta"),r=he(),o=X("meta"),a=he(),l=X("link"),c=he(),u=X("link"),h=he(),d=X("link"),_=he(),p=X("body"),E=X("div"),E.innerHTML=A,K=he(),H=X("div"),V&&V.c(),this.h()},l(m){e=J(m,"TITLE",{"data-svelte-h":!0}),ns(e)!=="svelte-4n0mml"&&(e.textContent=t),s=ue(m),i=J(m,"META",{charset:!0}),r=ue(m),o=J(m,"META",{name:!0,content:!0}),a=ue(m),l=J(m,"LINK",{rel:!0,href:!0}),c=ue(m),u=J(m,"LINK",{rel:!0,href:!0}),h=ue(m),d=J(m,"LINK",{rel:!0,href:!0}),_=ue(m),p=J(m,"BODY",{class:!0});var R=ss(p);E=J(R,"DIV",{class:!0,style:!0,"data-svelte-h":!0}),ns(E)!=="svelte-1fm2tz8"&&(E.innerHTML=A),K=ue(R),H=J(R,"DIV",{class:!0,style:!0});var ts=ss(H);V&&V.l(ts),ts.forEach(L),R.forEach(L),this.h()},h(){G(i,"charset","UTF-8"),G(o,"name","viewport"),G(o,"content","width=device-width, initial-scale=1"),G(l,"rel","stylesheet"),G(l,"href","https://www.w3schools.com/w3css/4/w3.css"),G(u,"rel","stylesheet"),G(u,"href","https://fonts.googleapis.com/css?family=Raleway"),G(d,"rel","stylesheet"),G(d,"href","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"),G(E,"class","w3-bar w3-top w3-black w3-large"),Wt(E,"z-index","4"),G(H,"class","w3-main"),Wt(H,"margin-left","30px"),Wt(H,"margin-top","43px"),G(p,"class","w3-light-grey svelte-nijqs7")},m(m,R){$(m,e,R),$(m,s,R),$(m,i,R),$(m,r,R),$(m,o,R),$(m,a,R),$(m,l,R),$(m,c,R),$(m,u,R),$(m,h,R),$(m,d,R),$(m,_,R),$(m,p,R),Ut(p,E),Ut(p,K),Ut(p,H),V&&V.m(H,null),Q=!0},p(m,[R]){V&&V.p&&(!Q||R&1)&&Ar(V,Le,m,m[0],Q?kr(Le,m[0],R,null):Dr(m[0]),null)},i(m){Q||(Or(V,m),Q=!0)},o(m){Mr(V,m),Q=!1},d(m){m&&(L(e),L(s),L(i),L(r),L(o),L(a),L(l),L(c),L(u),L(h),L(d),L(_),L(p)),V&&V.d(m)}}}function kh(n,e,t){let{$$slots:s={},$$scope:i}=e;return n.$$set=r=>{"$$scope"in r&&t(0,i=r.$$scope)},[i,s]}class Lh extends Pr{constructor(e){super(),xr(this,e,kh,Dh,Nr,{})}}export{Lh as component,Mh as universal};
