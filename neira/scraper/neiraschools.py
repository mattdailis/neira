...
boys_fours = {
    ...
    "Nobles",
    "NMH",
    "Notre Dame",  # TODO are there multiple Notre Dames?
    "Pingree",
    "Pomfret",
    "St. Mark's",
    "St. Mary's-Lynn",
...
aliases = {
    ...
    "Bedford": [],
    "Belmont Hill": ["BHS"],
    "Berkshire Academy": ["Berkshire", "Berksh."],
    "Berwick": ["Berwick Mixed C", "Berwick Academy", "Berwick Academy A"],
    "Boston Latin": ["BLS"],
    ...
    "Pingree": [],
    "Pomfret": [],
    "Sacred Heart": ["Sacred Heart Greenwich"],
    "Salisbury": [],
    "Shrewsbury": [],
    "Simsbury": [],
    "St. John's Prep": [],
